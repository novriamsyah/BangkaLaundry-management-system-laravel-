...
<style type="text/css">
	...
	.gradient-1 {
		background: linear-gradient(230deg, #ff0000, #ffffff)
	}
	.gradient-2 {
		background: linear-gradient(230deg, #009933, #ffffff)
	}
	.gradient-3 {
		background: linear-gradient(230deg, #ffcc66, #ffffff)
	}
	.gradient-4 {
		background: linear-gradient(230deg, #3399ff, #ffffff)
	}
...
<div class="page-header">
    <div class="row align-items-center">
        <div class="col">
            <div class="mt-5">
                <h6 class="card-title float-right mt-2"><a href="#">Laporan</a>/ <a href="{{ url('/laporan_pegawai') }}">Laporan Pegawai</a></h6></div>
        </div>
    </div>
</div>

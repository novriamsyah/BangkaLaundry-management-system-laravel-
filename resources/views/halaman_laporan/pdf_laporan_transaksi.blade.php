...
<body>
	<div class="header">
		<table style="width: 100%;" class="table-header">
			<tr>
				<td style="padding-top: 50px; padding-left: 50px;"><img src="{{ asset('icons/icon/favx.png') }}" class="logo-laundry"></td>
				<td class="text-right" style="padding-top: 50px; padding-right: 50px;">Bangka Londry<br>Jasa Laundry Terbaik di Indonesia</td>
			</tr>
			<tr>

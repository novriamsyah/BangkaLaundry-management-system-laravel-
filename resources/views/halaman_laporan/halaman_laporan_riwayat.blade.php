...
<div class="page-header">
    <div class="row align-items-center">
        <div class="col">
            <div class="mt-5">
                <h6 class="card-title float-right mt-2"><a href="#">Laporan</a> / <a href="{{ url('/laporan_pegawai') }}">Laporan Pegawai</a> / <a href="{{ url('/laporan_pegawai_riwayat/' . $id) }}">Riwayat Kerja Pegawai</a></h6></div>
        </div>
    </div>
</div>
		                            ...
		                            <tbody class="isi_tabel">
		                            	...
		                            	<tr>
		                            		...
		                            		<td>
			                                    ...
			                                    <span class="btn btn-sm bg-info mr-2 text-white">{{ $riwayat->status }}</span>
			                                    @elseif($riwayat->status == 'proses')
			                                    <span class="btn btn-sm bg-warning mr-2 text-white">{{ $riwayat->status }}</span>
			                                    @elseif($riwayat->status == 'selesai')
			                                    <span class="btn btn-sm bg-success mr-2 text-white">{{ $riwayat->status }}</span>
			                                    @elseif($riwayat->status == 'diantar')
			                                    <span class="btn btn-sm bg-danger mr-2 text-white">{{ $riwayat->status }}</span>
			                                    @elseif($riwayat->status == 'diambil')
			                                    <span class="btn btn-sm bg-primary mr-2 text-white">{{ $riwayat->status }}</span>
			                                    @endif
			                                </td>
		                            	</tr>
		                            	@endforeach

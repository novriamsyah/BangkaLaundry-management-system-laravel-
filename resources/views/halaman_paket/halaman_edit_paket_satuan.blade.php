...
<div class="page-header">
    <div class="row align-items-center">
        <div class="col">
            <div class="mt-5">
                <h6 class="card-title float-right mt-2"><a href="#">Kelola Data</a> / <a href="{{ url('/kelola_paket') }}">Kelola Paket</a> / <a href="{{ url('/edit_paket_satuan/' . $id) }}">Edit Paket Satuan</a></h6></div>
        </div>
    </div>
</div>

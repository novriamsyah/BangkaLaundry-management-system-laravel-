...
<div class="page-header">
    <div class="row align-items-center">
        <div class="col">
            <div class="mt-5">
                <h6 class="card-title float-right mt-2"><a href="#">Kelola Data</a> / <a href="{{ url('/kelola_paket') }}">Kelola Paket</a> / <a href="{{ url('/edit_paket_kiloan/' . $id) }}">Edit Paket Kiloan</a></h6></div>
        </div>
    </div>
</div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-validation">
                        <form class="form-valide" action="{{ url('/update_paket_kiloan/' . $id) }}" method="post" name="edit_paket_kiloan_form">
                            @csrf
...
var id_outlet = "{{ $paket_kilos->id_outlet }}";

$(document).ready(function(){
    $('.'+id_outlet+'_outlet_id').prop('selected', true);

    if({{ $paket_kilos->antar_jemput_paket }} == 1)
    {
        $('.check-antar').attr('checked', true);
    }else{
        $('.check-antar').attr('checked', false);
    }
});
...
$(function() {
  $("form[name='edit_paket_kiloan_form']").validate({
    rules: {
      nama_paket: "required",
      harga_paket: {
        required: true,

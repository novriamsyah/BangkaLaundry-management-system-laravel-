...
<div class="page-header">
    <div class="row align-items-center">
        <div class="col">
            <div class="mt-5">
                <h6 class="card-title float-right mt-2"><a href="#">Layanan Laundry</a> / <a href="{{ url('/kelola_pelanggan') }}">Kelola Pelanggan</a> / <a href="{{ url('/detail_pelanggan_non_member/' . $id) }}">Detail Pelanggan</a></h6></div>
        </div>
    </div>
</div>

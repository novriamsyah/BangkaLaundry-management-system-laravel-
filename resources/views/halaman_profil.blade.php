    				...
    				<form method="POST" class="ubah_password_form">
    					...
    					<div class="form-row">
    						<div class="form-group col-12">
	    						<input type="password" name="old_password" class="form-control form-control-xl" placeholder="Password lama">
	    					</div>
	    					<div class="form-group col-12">
	    						<input type="password" name="new_password" class="form-control form-control-xl" placeholder="Password baru">
	    					</div>
	    					<div class="form-group col-12">
    			...
    			<div class="card-body">
    				...
    				<div class="row">
    					<div class="col-md-12 d-flex justify-content-start mb-2">
    						<select id="maxRows" class="form-control-lm ml-2" style="width: 100px;">
                    			<option value="9999">Semua</option>
                    			<option value="5">5</option>
                    			<option value="10">10</option>
                    			<option value="25">25</option>
                    		</select>
    						<input type="text" name="cari_input" placeholder="Cari" class="form-control cari_input form-control-xl ml-4">
    					</div>
    					<div class="col-md-12">
							  ...
							  <tbody class="isi_tabel">
							  	...
							  	<tr>
							  		...
							  		<td>@if($transaksi->status == 'baru')
	                                    <span class="btn btn-sm bg-danger-light mr-2">{{ $transaksi->status }}</span>
	                                    @elseif($transaksi->status == 'proses')
	                                    <span class="btn btn-sm bg-success-light mr-2">{{ $transaksi->status }}</span>
	                                    @elseif($transaksi->status == 'selesai')
	                                    <span class="btn btn-sm bg-primary-light mr-2">{{ $transaksi->status }}</span>
	                                    @elseif($transaksi->status == 'diantar')
	                                    <span class="btn btn-sm bg-warning-light mr-2">{{ $transaksi->status }}</span>
